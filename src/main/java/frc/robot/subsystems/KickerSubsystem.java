...
public class KickerSubsystem extends SubsystemBase {
  ...
  private SparkMax spark = new SparkMax(Constants.ShooterConstants.kShooterKickerPort, MotorType.kBrushless);
 ...
 private final FlyWheelConfig kickerConfig = new FlyWheelConfig(motor)
   ...
   */
  public AngularVelocity getVelocity() {return kicker.getSpeed();}
  /**
   ...
   */
  public Command setVelocity(AngularVelocity speed) {return kicker.run(speed);}
   ...
   * @param speed Speed to set
   */
  public void setVelocitySetpoint(AngularVelocity speed) {kicker.setMechanismVelocitySetpoint(speed);}
   ...
   * @return {@link edu.wpi.first.wpilibj2.command.RunCommand}
   */
  public Command set(double dutyCycle) {return kicker.set(dutyCycle);}
