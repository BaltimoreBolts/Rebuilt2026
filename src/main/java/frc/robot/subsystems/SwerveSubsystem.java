...
public class SwerveSubsystem extends SubsystemBase {
  ...
  // Update this to use QuestNav is connected
  private final boolean IS_QUESTNAV_ENABLED = false;

  public double getDistanceToHub() {
    if (IS_QUESTNAV_ENABLED) {
  ...
  /* Variables needed for quest nav functionality  */
  // private static QuestNav m_questNav = Robot.m_questNav;
  // private static QuestNavSubsystem m_questNavSubsystem = Robot.m_questNavSubsystem;
  ...
  public void updateVisionOdometry() {
    ...
    //     if (m_questNav.isConnected() && questFrame.isTracking()) {
    //         System.out.println("Going to update swerve drive pose");
    //         m_questNavSubsystem.updateSwerveDrivePose(questFrame, swerveDrive);
    //     }
    // }
  }
