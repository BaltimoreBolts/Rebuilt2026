...
public class IntakeSubsystem extends SubsystemBase {
  ...
  private SparkMax rollerSpark =
      new SparkMax(Constants.IntakeConstants.kIntakeRollerPort, MotorType.kBrushless);
  ...
  private SmartMotorControllerConfig intakePivotSmartMotorConfig =
      new SmartMotorControllerConfig(this)
  ...
  private SparkMax spark =
      new SparkMax(Constants.IntakeConstants.kIntakeDeployPort, MotorType.kBrushless);

  // Create our SmartMotorController from our Spark and config with the NEO.
  private SmartMotorController intakePivotController =
      new SparkWrapper(spark, DCMotor.getNEO(1), intakePivotSmartMotorConfig);

  private ArmConfig intakePivotConfig =
      new ArmConfig(intakePivotController)
  ...
  public Command setAngleAndStop(Angle angle) {
    return intakePivot.runTo(angle, Degrees.of(2));
  }
  ...
  /** Command to deploy intake and run roller while held. Stops roller when released. */
