...
public class FieldConstants {
  ...
  public static class LinesVertical {
    ...
    public static final double hubCenter = field.getTagPose(26).get().getX() + Hub.width / 2.0;
    ...
    public static final double oppHubCenter = field.getTagPose(4).get().getX() + Hub.width / 2.0;
    public static final double oppAllianceZone = field.getTagPose(10).get().getX();
  }
  ...
  public static class Hub {
    ...
    public static final Pose2d HubPoseBlue =
        new Pose2d(
            new Translation2d(field.getTagPose(26).get().getX() + width / 2.0, fieldWidth / 2.0),
            new Rotation2d());
    ...
    public static final Translation3d topCenterPoint =
        new Translation3d(
            field.getTagPose(26).get().getX() + width / 2.0, fieldWidth / 2.0, height);
    public static final Translation3d innerCenterPoint =
        new Translation3d(
            field.getTagPose(26).get().getX() + width / 2.0, fieldWidth / 2.0, innerHeight);
    ...
    public static final Translation3d oppTopCenterPoint =
        new Translation3d(field.getTagPose(4).get().getX() + width / 2.0, fieldWidth / 2.0, height);
  ...
  public static final ArrayList<Pose3d> TrenchPose =
      new ArrayList<>(4); // Starting at the right branch facing the
  ...
  public static class Tower {
    ...
    public static final Translation2d centerPoint =
        new Translation2d(frontFaceX, field.getTagPose(31).get().getY());
    ...
    public static final Translation2d oppCenterPoint =
        new Translation2d(fieldLength - frontFaceX, field.getTagPose(15).get().getY());
  ...
  public static class Outpost {
    ...
    // Relevant reference points on alliance side
    public static final Translation2d centerPoint =
        new Translation2d(0, field.getTagPose(29).get().getY());
  }
}
